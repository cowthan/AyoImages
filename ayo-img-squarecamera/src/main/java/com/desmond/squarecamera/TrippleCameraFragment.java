...
public class TrippleCameraFragment extends Fragment implements SurfaceHolder.Callback, Camera.PictureCallback {

    public static final String TAG = TrippleCameraFragment.class.getSimpleName();
    ...
    public static Fragment newInstance() {
        return new TrippleCameraFragment();
    }

    TextView cover_top_view, cover_bottom_view;
    ImageView iv_cover;

    public TrippleCameraFragment() {}
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.squarecamera__tripple_fragment_camera, container, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mPreviewView.getHolder().addCallback(TrippleCameraFragment.this);
...
//                    Log.d(TAG, "cover height " + topCoverView.getHeight());
        ...
        cover_top_view = (TextView) view.findViewById(R.id.cover_top_view);
        cover_bottom_view = (TextView) view.findViewById(R.id.cover_bottom_view);
...
//        Log.d(TAG, "Rotate Picture by: " + rotation);
        getFragmentManager()
                ...
                .replace(
                        ...
                        TrippleEditSavePhotoFragment.newInstance(data, rotation, mImageParameters.createCopy()),
                        TrippleEditSavePhotoFragment.TAG)
                .addToBackStack(null)
                .commit();
    ...
    private int[] faces = {
            R.drawable.face_front, R.drawable.face_left, R.drawable.face_right
    };

    public void refresh() {
        int index = TrippleManager.photos.size();
        //Toast.makeText(getActivity().getApplicationContext(), index+"", Toast.LENGTH_SHORT).show();
        if(index < 0 || index > 2) return;
        cover_top_view.setText(titles[index]);
        cover_bottom_view.setText(titles[index]);
        iv_cover.setImageResource(faces[index]);
    }
}
