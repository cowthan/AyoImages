...
public class ImageLoadAsync extends MediaAsync<String,String, String>{
	...
	protected void onPostExecute(String result) {
		...
		MediaChooser.IImageLoader iImageLoader = MediaChooser.getImageLoader();
		if(iImageLoader == null){
			throw new RuntimeException("必须给MediaChooser传入一个IImageLoader");
		}

		iImageLoader.loadImage(mContext, mImageView, result);
