...
public class DirectoryListActivity extends FragmentActivity {
	...
	public static ArrayList<String> imagesSelectedBefore;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		imagesSelectedBefore = (ArrayList<String>) getIntent().getSerializableExtra("selected");
		if(imagesSelectedBefore == null) imagesSelectedBefore = new ArrayList<>();
		Log.i("mediachooser", "DirectorList--" + max + ", " + imagesSelectedBefore.size());
		...
		this.getSupportFragmentManager().beginTransaction().replace(R.id.root,bucketImageFragment).commit();
