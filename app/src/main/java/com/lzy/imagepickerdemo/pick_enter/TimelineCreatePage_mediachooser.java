 ...
 * ================================================
 */
public class TimelineCreatePage_mediachooser extends BaseTimelineCreatePage implements ImagePickerAdapter.OnRecyclerViewItemClickListener {
    ...
    protected void pick(){
        ...
        imagePickerDelegate.startForResult(maxImgCount - selImageList.size(), null);
    }
