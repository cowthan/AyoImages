 ...
 * ================================================
 */
public class TimelineCreatePage_mediachooser_single extends BaseTimelineCreatePage implements ImagePickerAdapter.OnRecyclerViewItemClickListener {
    ...
    protected void pick(){
        ...
        imagePickerDelegate.pickSingle(false);
    }
